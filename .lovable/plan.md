...
- The book on the shelf with the blank icon is **"The Fox and the Tiger"**. Its cover is empty in the database (`cover_url: null`) and both of its chapters have no image either. So there is nothing to show — the reader is falling back to the book-icon placeholder correctly.
...
5. **Fix this actual book**: after the change, run Repaint on "The Fox and the Tiger" and confirm its cover and chapter pictures appear.

## Verification before I call it done

- Repaint the empty book and confirm the database rows now hold a cover and chapter images.
